...
public class GeneralController {
    ...
    @GetMapping(value = "/available-filters", produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<String> availableFilters() {
        List<List<AvailableFilters>> availableFilters = of(AvailableFilters.CERTIFICATE_FILTER_KEYS);
