...
package in.codebuckets.acmemanager.server.dto;

import in.codebuckets.acmemanager.server.acme.ChallengeType;
 ...
 */
public record Challenge(ChallengeType challengeType, String domain, Status status, String challengeToken, String challengeAuthorization) {

    public Challenge(ChallengeType challengeType, String domain, Status status) {
