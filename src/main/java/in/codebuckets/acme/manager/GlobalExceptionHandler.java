...
import static in.codebuckets.acme.manager.Jackson.toJson;
import static in.codebuckets.acme.manager.Responses.badRequest;
import static in.codebuckets.acme.manager.Responses.internalServerError;
...
public class GlobalExceptionHandler {
    ...
    public static final Function<Throwable, ResponseEntity<String>> GENERIC_EXCEPTION_HANDLER = throwable -> {
        if (throwable.getCause() instanceof ServiceException exception) {
